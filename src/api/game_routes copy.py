...
from api.handlers import handle_combat, handle_skill_check
    ...
    try:
        ...
        if player and player.effective_hit_points <= 0:
            ...
            if resurrection_event == "resurrection_event" and resurrection_conf > 0.6:
                ...
                return await _handle_resurrection(request, player)
...
async def _handle_resurrection(request: GameCommandRequest, player: Player) -> GameCommandResponse:
